        ...
        <div id="admin">
            ...
            <H1>Persons with Disability Database</h1>  
                <form name="form2" action="" method="post">
                    ...
                    <br>
                    <p>Delete an entire row of record by entering the unique ID</p>
                    <p>View the database first to be certain of the record you're going to delete.</p>
...
{
    mysqli_query($link, "delete from pwdinfo where ID='$_POST[id]'");
